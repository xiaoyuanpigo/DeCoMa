...
class Model(nn.Module):
    ...
    def forward_emb(self, source_embeddings, source_ids, source_mask):
        outputs = self.get_t5_vec(source_ids=source_ids, source_embeddings=source_embeddings, source_mask=source_mask)[0]
        return outputs
