...
3. `conda activate DeCoMa`
    ...
    4. Clone the official repositories of [tree-sitter-java](https://github.com/tree-sitter/tree-sitter-java) and [tree-sitter-python](https://github.com/tree-sitter/tree-sitter-python)
